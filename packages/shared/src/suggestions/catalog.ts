...
export const HEALTHY_RECIPES: readonly RecipeSpec[] = [
  ...
  { id: 'h130', kind: 'bowl', method: 'bowl', label: 'Bowl saumon, riz et avocat', source: 'yourdietexpert.com', diets: OMNI, prep: 10, cook: 15, equipment: CASS, tags: MAIN, protein: ['saumon'], starch: ['riz'], vegetable: true },
  ...
  { id: 'h146', kind: 'four', method: 'oven', label: 'Aubergine rôtie au yaourt', source: 'tangerinezest.com', diets: VEGE, prep: 10, cook: 30, equipment: FOUR, tags: MAIN, vegetable: ['aubergine'], dairy: true, protein: LEGUME },
  ...
  { id: 'h149', kind: 'four', method: 'oven', label: 'Courge rôtie et chèvre', source: 'elle.fr', diets: VEGE, prep: 10, cook: 30, equipment: FOUR, tags: MAIN, vegetable: ['potiron', 'butternut'], dairy: true, protein: LEGUME },
